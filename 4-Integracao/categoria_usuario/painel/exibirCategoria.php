            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="exibirUsuario.php?id=<?php echo $_SESSION['idUsuario']; ?>" >
                                <div><p>Bem Vindo usuário: <span> <?php echo $_SESSION['nome']; ?> </span></p>                            
                                </div>
                            </a>                            
                        </li>
                    </ul>
                ...
                <div class="container-fluid">
                    ...
                    <form action="editarCategoria.php" method="POST">
                        ...
                        <br />
                        <input name="nome" class="form-control"id="nome" placeholder="Escreva o nome da categoria" type="text" value="<?php echo $nome;?>"  />
                        <br />
                        <label for="descricao">Descrição:</label>
                        <br />
                        <textarea name="descricao" id="descricao" class="form-control" placeholder="Escreva a descricao"><?php echo $descricao;?></textarea>                                            
                        <br />
